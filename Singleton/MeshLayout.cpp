...
)
{
	...
	{
		target.push_back(
			{ "BONEINDEX", 0, DXGI_FORMAT_R32G32B32A32_SINT, 0, 0, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 }
		);
		target.push_back(
			{ "BONEWEIGHT", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 0 , D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 }
		);
	}
}
#include <mutex>
