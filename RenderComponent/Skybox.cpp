...
) const
{
	...
	shader->BindRootSignature(commandList, Graphics::GetGlobalDescHeap());
	shader->SetResource(commandList, ShaderID::GetMainTex(), Graphics::GetGlobalDescHeap(), skyboxTex->GetGlobalDescIndex());
